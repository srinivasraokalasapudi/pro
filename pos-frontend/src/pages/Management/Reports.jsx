...
const Reports = () => {
  ...
  const foods = data?.topSellingFoods || [];

  const cards = [
    { title: "Daily Sales", value: `₹${summary.todaySales || 0}`, icon: <FaChartLine /> },
    { title: "Weekly Sales", value: `₹${summary.weeklySales || 0}`, icon: <FaChartLine /> },
    { title: "Monthly Sales", value: `₹${summary.monthlySales || 0}`, icon: <FaChartLine /> },
    { title: "Revenue", value: `₹${summary.totalRevenue || 0}`, icon: <FaMoneyBillWave /> },
    { title: "Tax", value: `₹${summary.totalTax || 0}`, icon: <FaReceipt /> },
